...
const agregarGasto = (body) => {
  ...
  // primero compara quien hizo el pago con los otros roommies y luego calcula cuanto debe y recibe
  roommateData.map((e) => {
...
//Función para modificar las cuentas correspondientes a los gastos realizados por los roommates
