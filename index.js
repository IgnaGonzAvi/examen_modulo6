...
const fs = require("fs");
const { v4: uuidv4 } = require("uuid"); //asigna id
const url = require("url"); //almacena el random user
const { agregarRoommate, guardarUsuario, reset } = require("./roomate.js");
// const { enviar } = require("./n_mailer");
const { agregarGasto, modificarGasto } = require("./cuentas"); //importada cuentas
...
// agrega usuario a la columna izquierda
